                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            ...
                            <ul class="discover triangle hover row">
                                <li class="col-xs-6"><a href="<?php echo site_url('main/index'); ?>">Inicio</a></li>
                                <li class="col-xs-6"><a href="<?php echo site_url('main/eventos'); ?>">Eventos</a></li>
                                <li class="col-xs-6"><a href="<?php echo site_url('main/grupos'); ?>">Grupos</a></li>
                                <li class="col-xs-6"><a href="<?php echo site_url('main/locales'); ?>">Locales</a></li>
                                <li class="col-xs-6"><a href="<?php echo site_url('main/contactus'); ?>">Contactanos</a></li>
                                <li class="col-xs-6"><a href="<?php echo site_url('main/faq'); ?>">FAQ</a></li>
                                <li class="col-xs-6"><a href="<?php echo site_url('main/aboutus'); ?>">Sobre Nosotros</a></li>
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <p>YourPassion es una red en la cual músicos pueden darse a conocer y al mismo tiempo un lugar para organizar eventos del mismo estilo.</p>
                            <br />
                            <address class="contact-details">
                                <a href="#" class="contact-email">contacto@yourpassionweb.com</a>
                            </address>
                ...
                <div class="container">
                    <div class="pull-left">
                        <a href="<?php echo site_url('main/index'); ?>" title="YourPassion">
                            <img height="50" width="175" src="<?php echo base_url('assets/images/YP-logo_full-black.png'); ?>" style="margin-top:2%;"/>
                        </a>
                    </div>
    ...
    <script type="text/javascript" src="<?php echo base_url('assets/components/revolution_slider/js/jquery.themepunch.tools.min.js'); ?>"></script>
